    ...
    <div>
      ...
      >
        <div class="px-4 py-5 sm:p-6">
          <dt class="text-base font-normal text-gray-900">Impression</dt>
        ...
        <div class="px-4 py-5 sm:p-6">
          <dt class="text-base font-normal text-gray-900">CTR</dt>
          <dd class="mt-1 flex items-baseline justify-between md:block lg:flex">
            <div
              class="flex items-baseline text-2xl font-semibold text-indigo-600"
            >
      ...
      >
        <div class="px-4 py-5 sm:p-6">
          <dt class="text-base font-normal text-gray-900">Cost</dt>
          <dd class="mt-1 flex items-baseline justify-between md:block lg:flex">
            <div
              class="flex items-baseline text-2xl font-semibold text-indigo-600"
            >
        ...
        <div class="px-4 py-5 sm:p-6">
          <dt class="text-base font-normal text-gray-900">CPC</dt>
          <dd class="mt-1 flex items-baseline justify-between md:block lg:flex">
            <div
              class="flex items-baseline text-2xl font-semibold text-indigo-600"
            >
        ...
        <div class="px-4 py-5 sm:p-6">
          <dt class="text-base font-normal text-gray-900">Conversion</dt>
          <dd class="mt-1 flex items-baseline justify-between md:block lg:flex">
            <div
              class="flex items-baseline text-2xl font-semibold text-indigo-600"
            >
      ...
      >
        <div class="px-4 py-5 sm:p-6">
          <dt class="text-base font-normal text-gray-900">CPA</dt>
          <dd class="mt-1 flex items-baseline justify-between md:block lg:flex">
            <div
              class="flex items-baseline text-2xl font-semibold text-indigo-600"
            >
        ...
        <div class="px-4 py-5 sm:p-6">
          <dt class="text-base font-normal text-gray-900">CVR</dt>
          <dd class="mt-1 flex items-baseline justify-between md:block lg:flex">
            <div
              class="flex items-baseline text-2xl font-semibold text-indigo-600"
            >
